 ...
 */
final class Version20220901032528 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_product CHANGE unit_price unit_price DOUBLE PRECISION NOT NULL');
